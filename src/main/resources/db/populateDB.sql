...
INSERT INTO employees (name, surname, school, department, post, workload, salary, email,user_id)
VALUES
    ('Сергей','Цапко',	'ИШИТР','ОИТ','Доцент',150,36500,'sgt@tpu.ru',1),
    ('Михаил','Мужикбаев',	'ИШИТР','ОИТ','Ассистент',120,19700,'mam59@tpu.ru',null),
    ('Владимир','Попов','ИШИТР','ОИТ','Преподаватель',130,28100,'vnp@tpu.ru',null);
INSERT INTO student_group(name,students)
VALUEs
    ('8K03',22),
    ('8K04',24);
INSERT INTO students (name, surname,school,direction,specialization,course, group_name, omissions,scores,user_id)
VALUES
    ('Матвей', 'Науменко','ИШИТР','Программная инженерия','кто знает',3 ,'8K03',0,0,null),
    ('Даниил', 'Климов','ИШИТР','Программная инженерия','кто знает',3 , '8K03',0,0,null),
    ('Екатерина', 'Леонова','ИШИТР','Программная инженерия','кто знает',3 , '8K03',0,0,null),
    ('Денис', 'Финенко','ИШИТР','Программная инженерия','кто знает',3 , '8K03',0,0,null),
    ('Иван', 'Вебер','ИШИТР','Программная инженерия','кто знает',3 , '8K03',0,0,null),
    ('Михаил', 'Семенов','ИШИТР','Программная инженерия','кто знает',3 , '8K04',0,0,null),
    ('Александра', 'Смирнова','ИШИТР','Программная инженерия','кто знает',3 , '8K04',0,0,null),
    ('Михаил', 'Мужикбаев','ИШИТР','Программная инженерия','кто знает',3 , '8K04',0,0,2),
    ('Полина', 'Астахова','ИШИТР','Программная инженерия','кто знает',3 , '8K04',0,0,null),
    ('Елизавета', 'Колотова','ИШИТР','Программная инженерия','кто знает',3 , '8K04',0,0,null);
